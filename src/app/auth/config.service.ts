...
const CONFIG = [
  ...
  },
  {
    ...
    attributes: {
      addressFields: false,
      biggerFont: true,
      cities: [4160, 18233, 10406, 8620, 11160, 13853, 14970, 18603, 20611, 21725, 21203, 13620, 13207, 5409, 10805, 15499],
      countries: ['all'],
...
export class ConfigService {
  ...
  getUserConfig(userId, attribute?) {
    const userConfig = CONFIG.find(config => config.user === userId);
    if (!userConfig) {
      return [];
    }
    if (attribute) {
